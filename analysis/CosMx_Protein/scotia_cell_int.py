...
known_lr_pairs = pd.read_csv('analysis/CosMx_Protein/Files/lr_pair.csv',sep=',', index_col = None)
...
for patient in samples:
  ...
  meta_df = pd.read_csv('analysis/CosMx_Protein/Files/'+patient+'_meta_def.csv',sep=',',index_col=None)
  print(meta_df.head())
  exp_df = pd.read_csv('analysis/CosMx_Protein/Files/'+patient+'_exp_def.csv',sep=',',index_col=None)
  print(exp_df.head())
  ...
  for fov in fovs:
      ...
      meta_df_fov.to_csv('analysis/CosMx_Protein/Files/'+patient+'_fov_'+str(fov)+".csv",header = True, index = False, sep = "\t")
      ...
      np.save('analysis/CosMx_Protein/Files/'+patient+'_fov_'+str(fov)+'_dbscan.cell.clusters.test',tmp_df)
  ...
  #for fov in [9]:
      print(fov)
      #clustering result
      cluster_df = pd.DataFrame(np.load('analysis/CosMx_Protein/Files/'+patient+'_fov_'+str(fov)+'_dbscan.cell.clusters.test.npy',allow_pickle=True))
      ...
      if ga_df_final.shape[0]>0:
          ...
          ga_df_final.to_csv('analysis/CosMx_Protein/Files/'+patient+'_fov_'+str(fov)+".ot.csv",header = True, index = False, sep = "\t")
