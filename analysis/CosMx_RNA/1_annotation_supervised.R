...
#Read seurats
seurats <- readRDS( "analysis/CosMx_RNA/Objects/qc_seurats_pass.RDS")
...
#Write meta file
write.csv(seurats.75@meta.data,"analysis/CosMx_RNA/Objects/meta.csv")
...
#Read Reference
todas_epi <- readRDS('data/epi_sc_reference.RDS')
...
seu <- readRDS("analysis/CosMx_RNA/Objects/seurats75.RDS")
...
saveRDS(epi,"analysis/CosMx_RNA/Objects/epi.RDS")
...
write.csv(markers,"analysis/CosMx_RNA/Markers/epi.csv")

#Myeloids-----------------------------------------------------------------------

#Read Reference
todas_myeloids <- readRDS('data/myeloids_sc_reference.RDS')
...
saveRDS(myeloids,"analysis/CosMx_RNA/Objects/myeloids.RDS")
...
write.csv(markers,"analysis/CosMx_RNA/Markers/myeloids.csv")

#Tcells-------------------------------------------------------------------------

#Read Reference
todas_tcells <- readRDS('data/tcells_sc_reference.RDS')
...
saveRDS(tcells,"analysis/CosMx_RNA/Objects/tcells.RDS")
...
write.csv(markers,"analysis/CosMx_RNA/Markers/tcells.csv")


#Plasmas------------------------------------------------------------------------

#Read Reference Plasmas
todas_plasmas <- readRDS('data/plasmas_sc_reference.RDS')
...
saveRDS(plasmas,"analysis/CosMx_RNA/Objects/plasmas.RDS")
...
write.csv(markers,"analysis/CosMx_RNA/Markers/plasmas.csv")

#Stroma-------------------------------------------------------------------------

#Read Reference Stroma
todas_stroma <- readRDS('data/stroma_sc_reference.RDS')
...
saveRDS(stroma,"analysis/CosMx_RNA/Objects/stroma.RDS")
...
write.csv(markers,"analysis/CosMx_RNA/Markers/stroma.csv")

#Fuse all together--------------------------------------------------------------

tcells <- readRDS("analysis/CosMx_RNA/Objects/tcells.RDS")
plasmas <- readRDS("analysis/CosMx_RNA/Objects/plasmas.RDS")
epi <- readRDS("analysis/CosMx_RNA/Objects/epi.RDS")
myeloids <- readRDS("analysis/CosMx_RNA/Objects/myeloids.RDS")
stroma <- readRDS("analysis/CosMx_RNA/Objects/stroma.RDS")
...
saveRDS(seurats_all,"analysis/CosMx_RNA/Objects/seurats_all.RDS")
write.csv(seurats_all@meta.data,"analysis/CosMx_RNA/Objects/meta.csv")
