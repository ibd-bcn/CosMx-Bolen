...
density_plots <- function(gene, cells, seurat) {
  ...
  p <- ggplot(ccl18, aes(x = refined, y = mean_ccl18,
                         group = tissue, fill = tissue, color = tissue)) +
...
ggsave("figures/plots/fig2A.png",
       plot = p, width = 12, height = 9, dpi = 300)

## Ai -------------------------------------------------------------------------
mmtt <- meta
mmtt[mmtt$subset != "epi", ]$subset <- "other"
p <- plot_pol(object = mmtt, fov = "26", annotation = "subset",
              pal = subset_col, mols_c = TRUE, mols = mols,
              poly = pols, pt_size = 2, genes = "FERT")

ggsave("figures/plots/fig2Ai.png",
       plot = p, width = 13, height = 10, dpi = 300)

## Aii ------------------------------------------------------------------------
mmtt <- meta
mmtt[mmtt$subset != "epi", ]$subset <- "other"
p <- plot_pol(object = mmtt, fov = "13", annotation = "subset",
              pal = subset_col, mols_c = TRUE, mols = mols,
              poly = pols, pt_size = 2, genes = "FERT")

ggsave("figures/plots/fig2Aii.png",
       plot = p, width = 13, height = 10, dpi = 300)
...
ggsave("figures/plots/fig2B.png",
       plot = p, width = 12, height = 9, dpi = 300)

## Bi -------------------------------------------------------------------------
mmtt <- meta
mmtt[mmtt$subset != "epi", ]$subset <- "other"
p <- plot_pol(object = mmtt, fov = "10", annotation = "subset",
              pal = subset_col, mols_c = TRUE, mols = mols,
              poly = pols, pt_size = 2, genes = "FERT")

ggsave("figures/plots/fig2Bi.png",
       plot = p, width = 13, height = 10, dpi = 300)

## Bii ------------------------------------------------------------------------
mmtt <- meta
mmtt[mmtt$subset != "epi", ]$subset <- "other"
p <- plot_pol(object = mmtt, fov = "30", annotation = "subset",
              pal = subset_col, mols_c = TRUE, mols = mols,
              poly = pols, pt_size = 2, genes = "FERT")

ggsave("figures/plots/fig2Bii.png",
       plot = p, width = 13, height = 10, dpi = 300)

## C --------------------------------------------------------------------------
p <- volcano(anot   = "refined",
             ct     = "Colonocytes",
             seu    = seurat,
             id1    = "IBD",
             id2    = "NHC",
...
ggsave("figures/plots/fig2C.png",
       plot = p, width = 12, height = 9, dpi = 300)

## Ci -------------------------------------------------------------------------
mmtt <- meta
mmtt[mmtt$refined != "Colonocytes", ]$refined <- "other"
p <- plot_pol(object = mmtt, fov = "26", annotation = "refined",
              pal = refined_col, mols_c = TRUE, mols = mols,
              poly = pols, pt_size = 2, genes = "FERT")

ggsave("figures/plots/fig2Ci.png",
       plot = p, width = 13, height = 10, dpi = 300)

## Cii ------------------------------------------------------------------------
mmtt <- meta
mmtt[mmtt$refined != "Colonocytes", ]$refined <- "other"
p <- plot_pol(object = mmtt, fov = "13", annotation = "refined",
              pal = refined_col, mols_c = TRUE, mols = mols,
              poly = pols, pt_size = 2, genes = "FERT")

ggsave("figures/plots/fig2Cii.png",
       plot = p, width = 13, height = 10, dpi = 300)
...
ggsave("figures/plots/fig2D.png",
       plot = p, width = 12, height = 9, dpi = 300)

## Di -------------------------------------------------------------------------
mmtt <- meta
mmtt[mmtt$refined != "Colonocytes", ]$refined <- "other"
p <- plot_pol(object = mmtt, fov = "10", annotation = "refined",
              pal = refined_col, mols_c = TRUE, mols = mols,
              poly = pols, pt_size = 2, genes = "FERT")

ggsave("figures/plots/fig2Di.png",
       plot = p, width = 13, height = 10, dpi = 300)

## Dii ------------------------------------------------------------------------
mmtt <- meta
mmtt[mmtt$refined != "Colonocytes", ]$refined <- "other"
p <- plot_pol(object = mmtt, fov = "30", annotation = "refined",
              pal = refined_col, mols_c = TRUE, mols = mols,
              poly = pols, pt_size = 2, genes = "FERT")

ggsave("figures/plots/fig2Dii.png",
       plot = p, width = 13, height = 10, dpi = 300)

## E --------------------------------------------------------------------------
p <- density_plots(gene = "FERT",
                   cells = c("B cell","CD4","CD8","Colonocytes","Cycling TA",
                             "DCs","Endothelium","Enteroendocrine","Eosinophils",
                             "Fibroblasts","FRCs","Glia","Goblet",
                             "Inflammatory monocytes","M0","M1","M2","Mast",
                             "Myofibroblasts","Neutrophil","NK","PC IgA",
                             "PC IgG","Pericytes","S2"),
                   seurat = seurat)

ggsave("figures/plots/fig2E.png",
       plot = p, width = 15, height = 10, dpi = 300)

## F --------------------------------------------------------------------------
p <- density_plots(gene = "SLC40A1",
                   cells = c("B cell","CD4","CD8","Colonocytes","Cycling TA",
                             "DCs","Endothelium","Enteroendocrine","Eosinophils",
                             "Fibroblasts","FRCs","Glia","Goblet",
                             "Inflammatory monocytes","M0","M1","M2","Mast",
...
ggsave("figures/plots/fig2F.png",
       plot = p, width = 15, height = 10, dpi = 300)
